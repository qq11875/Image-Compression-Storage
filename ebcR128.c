...
int main(int argc, char **argv) {
    ...
    int numberOfParadigmBlocks = 128;
    if (numberOf3x3Block < 128) {
    ...
    outputParadigmBlocksAndImageToFile(argv[2], unpackedImageData, numberOfParadigmBlocks, packedR32Image, packedParadigmImage, "E7");
