...
int main(int argc, char **argv) {
    ...
    ebcRandomGetImageData(argv[1], unpackedImageData, packedR32Image, &pixelBlocks, PACK_SIZE, MAGIC_NUMBER_E5);
    ...
    ImageData *packedImage = packData(outputImage, outputImage->height, outputImage->width, PACK_SIZE);
